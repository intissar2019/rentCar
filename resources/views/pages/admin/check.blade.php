						...
						<div class="progress-table-wrap">
							<div class="progress-table">
								...
								<div class="table-row">
									...
									<div class="percentage">@if ($booking->pickUp < now())<span class="text-danger">Time Out </span><a href="{{route('handleBookingClear',['id'=>$booking->id])}}">Clear </a> @else
									<a href="{{route('handleBookingRefuse',['id'=>$booking->id])}}">Refuse</a> | <a href="{{route('handleBookingConfirm',['id'=>$booking->id])}}">Confirm</a>@endif</div>	
								</div>
								@endforeach
							</div>
						</div>
